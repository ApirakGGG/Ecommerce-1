...
const slides = [
  ...
  {
    id: 2,
    badge: "ช้อปฟินไม่ต้องจ่ายค่าส่ง! FREE SHIPPING คุ้มสองต่อ",
    title: "ORDER",
    highlight: "฿399+",
  ...
  },
  {
    ...
    title: "MONDAY SALE",
    highlight: " ",
    subtitle: "คัดสรรเส่งต่อความปัง! สินค้ามือสองสภาพดี ลดราคาจัดเต็ม 10% เอาใจสายช้อปต้นสัปดาห์",
    sub2: "แวะมาเลือกของที่ถูกใจด่วนๆ เฉพาะวันจันทร์นี้เท่านั้น! เพราะของดีไม่จำเป็นต้องเป็นของใหม่เสมอ 🛍️✨",
    ctaHref: "/products",
    image: "/discount.PNG",
    bg: "from-[#fdf6ec] via-[#f5e8d5] to-[#eddfc8]",
    badgeColor: "bg-[#8b5e3c]/15 border-[#8b5e3c]/30 text-[#5c3d1e]",
