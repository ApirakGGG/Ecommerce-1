...
const AddProductForm = () => {
  ...
  const onSubmit: SubmitHandler<FieldValues> = async (data) => {
    ...
    axios.post("/api/product", { ...data, images: uploadedImages })
      .then(() => {
    ...
    <div className="max-w-[860px] mx-auto px-4 py-8">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-[#4a3b2c]">Add New Product</h1>
            <p className="text-xs text-[#a0856a]">กรอกข้อมูลสินค้าให้ครบถ้วน</p>
          </div>
        </div>
